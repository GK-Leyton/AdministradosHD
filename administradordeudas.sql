...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-12-2024 a las 23:46:51
...
(1, 200000.000, 8, 5, 203223.298, '2024-12-16', 'Anlly', '2020-12-15', 140000.000, 1, NULL),
(2, 47000.000, 8, 5, 107755.298, '2024-12-16', 'Anlly', '2021-08-07', 47000.000, 1, NULL),
(3, 100000.000, 8, 5, 186016.702, '2024-12-16', 'Anlly', '2021-11-03', 100000.000, 1, NULL),
(4, 320000.000, 10, 5, 353700.035, '2024-12-16', 'Anlly', '2024-01-16', 320000.000, 1, NULL),
(5, 45800.000, 10, 5, 51143.368, '2024-12-16', 'Anlly', '2024-02-14', 45800.000, 1, NULL),
(7, 100000.000, 10, 6, 115999.964, '2024-12-16', 'Edwin Leyton', '2023-11-06', 100000.000, 1, NULL),
(8, 175000.000, 10, 6, 232749.965, '2024-12-16', 'Edwin Leyton', '2023-12-10', 175000.000, 1, NULL),
(9, 250000.000, 10, 6, 289166.641, '2024-12-16', 'Edwin Leyton', '2024-01-03', 250000.000, 1, NULL),
(10, 200000.000, 10, 6, 242000.035, '2024-12-16', 'Edwin Leyton', '2024-01-16', 200000.000, 1, NULL),
(11, 150000.000, 10, 6, 169500.000, '2024-12-16', 'Edwin Leyton', '2021-01-10', 150000.000, 1, NULL),
(12, 150000.000, 10, 6, 167000.000, '2024-12-16', 'Edwin Leyton', '2021-02-15', 150000.000, 1, NULL),
(13, 200000.000, 10, 6, 196333.369, '2024-12-16', 'Edwin Leyton', '2021-02-17', 200000.000, 1, NULL),
(14, 120000.000, 10, 6, 94800.000, '2024-12-16', 'Edwin Leyton', '2021-04-23', 120000.000, 1, NULL),
(15, 250000.000, 10, 6, 197499.965, '2024-12-16', 'Edwin Leyton', '2021-04-23', 250000.000, 1, NULL),
...
(45, 45000.000, 0, 10, 0.000, '0000-00-00', 'Marlon', '0000-00-00', 18000.000, 1, NULL),
(46, 50000.000, 10, 10, 53500.035, '2024-12-16', 'Marlon', '2023-01-29', 50000.000, 1, NULL),
(47, 220000.000, 10, 10, 245199.965, '2024-12-16', 'Marlon', '2023-02-02', 220000.000, 1, NULL),
(48, 40000.000, 10, 10, 39199.964, '2024-12-16', 'Marlon', '2023-02-26', 40000.000, 1, NULL),
(49, 140000.000, 10, 10, 123200.035, '2024-12-16', 'Marlon', '2023-02-26', 140000.000, 1, NULL),
...
(78, 350000.000, 10, 22, 372166.702, '2024-12-16', 'Karen', '2024-01-31', 350000.000, 1, NULL),
(79, 50000.000, 10, 6, 22666.702, '2024-12-16', 'Edwin Leyton ', '2024-07-21', 50000.000, 1, 'Deuda669da2217f9d7'),
...
(114, 1000.000, 10, 3, 106.000, '2024-12-16', 'Heider', '2024-08-15', 300.000, 1, ''),
...
(120, 312565.000, 0, 5, 0.000, '2024-09-18', 'Anlly', '2024-09-18', 162565.000, 1, 'Deuda66eba7fe94c44'),
...
(129, 132000.000, 0, 10, 0.000, '2024-12-09', 'Marlon', '2024-12-09', 132000.000, 1, 'Deuda675798c8eb9a7');
...
--
ALTER TABLE `deudas`
  MODIFY `id_deuda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;

--
-- AUTO_INCREMENT de la tabla `ganancias`
--
ALTER TABLE `ganancias`
  MODIFY `id_ganancia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59948;

--
-- AUTO_INCREMENT de la tabla `notificaciones`
--
ALTER TABLE `notificaciones`
  MODIFY `id_notificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4285;

--
-- AUTO_INCREMENT de la tabla `pagos`
--
ALTER TABLE `pagos`
  MODIFY `id_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=383;
