...
if ((!isset($_SESSION['PaginaAnterior'])) || (isset($_SESSION['PaginaAnterior']) && $_SESSION['PaginaAnterior'] == "../Vista/Login.php") && $_SESSION['PaginaAnterior'] == "../ControladorProcesarpago.php") {
    session_unset();
...
if (isset($_SESSION['PaginaAnterior']) && ($_SESSION['PaginaAnterior'] != "../Controlador/ProcesarLogin.php") && ($_SESSION['PaginaAnterior'] != "../Vista/VerClientesAdmin.php") && ($_SESSION['PaginaAnterior'] != "../Vista/VerPagosAdmin.php") && ($_SESSION['PaginaAnterior'] != "../Vista/DeudasActivasAdmin.php") && ($_SESSION['PaginaAnterior'] != "../Vista/DeudasFinalizadasAdmin.php") && ($_SESSION['PaginaAnterior'] != "../Vista/InterfazAdministrador.php") && ($_SESSION['PaginaAnterior'] != "../Controlador/ProcesarPago.php") && ($_SESSION['PaginaAnterior'] != "../Vista/PerfilUsuario.php") && ($_SESSION['PaginaAnterior'] != "../Vista/VerNotificacion.php") && ($_SESSION['PaginaAnterior'] != "../Vista/InsertarPrestamo.php") && ($_SESSION['PaginaAnterior'] != "../Vista/VerComprovantePago.php") && ($_SESSION['PaginaAnterior'] != "../Vista/DeudasActivasAdmin.php") && ($_SESSION['PaginaAnterior'] != "../Vista/MasInformacion.php") && ($_SESSION['PaginaAnterior'] != "../Vista/RealizarPagoAdmin.php") && ($_SESSION['PaginaAnterior'] != "../Vista/DeudasFinalizadasAdmin.php")) {
...
//header("Location: " . $_SESSION['PaginaAnterior']);
    ...
    $_SESSION['PaginaAnterior'] = "../Vista/InterfazAdministrador.php";
    $_SESSION['PaginaAnteriorAuxiliar'] = "../Vista/InterfazAdministrador.php";
}
...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="../Estilos/EstilosInterfazAdministrador.css">
        ...
        $result0 = $consulta->ObtenerCantidadNotificacionesActivasAdministrador();
        ...
        <div class="container">
                ...
                <div class="col-md-9">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="notification-container" id="notificationContainer">
                            ...
                            <?php
                            $result = $consulta->ObtenerNotificacionesIntereses_ParaElAdmin();
                            $result2 = $consulta->ObtenerNotificacionesPagos_ParaElAdmin();
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $consulta->obtenerDatosDeLasConsultas($result)) {
                                    ...
                                    <form id="formulario<?php echo $row['id_notificacion'] ?>" action="../Vista/VerNotificacion.php" method="post">
                                        ...
                                        <?php
                                        echo "<div " . ($row['estado2'] == 1 ? "style='background-color: #AFE6FF; font-weight: bold;'" : '') . " data-form-id='formulario" . $row['id_notificacion'] . "' class='notification'>Tu deuda con id " . $row['id_externo'] . "  acaba de aumentar su interés. <small style='float: right; font-size: 0.7em;'>" . $row['fecha'] . "</small></div>";
                                        ?>      
                                    </form>
                                    <?php
                                }
                            ...
                            if ($result2->num_rows > 0) {
                                while ($row2 = $consulta->obtenerDatosDeLasConsultas($result2)) {
                                    ...
                                    <form id="formulario<?php echo $row2['id_notificacion'] ?>" action="../Vista/VerNotificacion.php" method="post">
                                        ...
                                        <?php
                                        echo "<div " . ($row2['estado2'] == 1 ? "style='background-color: #AFE6FF; font-weight: bold;'" : '') . " data-form-id='formulario" . $row2['id_notificacion'] . "' class='notification'>Se acaba de registrar un pago con ID" . $row2['id_externo'] . "  en la deuda " . $row2['id_deuda'] . ". <small style='float: right; font-size: 0.7em;'>" . $row2['fecha'] . "</small></div>";
                                        ?>      
                                    </form>
                                    <?php
                                }
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="../Vista/VerClientesAdmin.php">Ver Clientes</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../Vista/VerPagosAdmin.php">Ver Pagos</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../Vista/DeudasActivasAdmin.php">Deudas Activas</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../Vista/DeudasFinalizadasAdmin.php">Deudas Finalizadas</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../Vista/PerfilUsuario.php">Perfil Usuario</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="../Controlador/ProcesarLogout.php">Cerrar Sesion</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
            ...
            document.getElementById('notificationButton').addEventListener('click', function () {
                ...
                if (container.style.display === 'none' || container.style.display === '') {
                    ...
                    button.style.boxShadow = '0 2px 4px blue';
