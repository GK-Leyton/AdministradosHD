...
if (isset($_SESSION['PaginaAnterior']) && ($_SESSION['PaginaAnterior'] != "../Vista/DeudasFinalizadasAdmin.php") && ($_SESSION['PaginaAnterior'] != "../Vista/InterfazAdministrador.php") && ($_SESSION['PaginaAnterior'] != "../Vista/MasInformacion.php") && ($_SESSION['PaginaAnterior'] != "../Vista/VerComprovantePago.php")) {
...
//header("Location: " . $_SESSION['PaginaAnterior']);
    ...
    $_SESSION['PaginaAnterior'] = "../Vista/DeudasFinalizadasAdmin.php";
    $_SESSION['PaginaAnteriorAuxiliar'] = "../Vista/DeudasFinalizadasAdmin.php";
    $_SESSION['PaginaAnteriorAuxiliar2'] = "../Vista/DeudasFinalizadasAdmin.php";
}
...
/* $stmt = $conn->prepare("select * from deudas where estado = 0;");
  $stmt->execute();
  $result = $stmt->get_result(); */
$result = $consulta->ObtenerDeudasPorEstado(0);
?>
...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="../Estilos/EstilosDeudasFinalizadasAdmin.css">
    ...
    <body>
        ...
        <div class="container">
                ...
                <div style="padding-top: 1em;" class="col-md-6" >
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="slogan ml-auto">
                            <p style="font-size: 1.5em; margin: 0 auto; color: black; font-weight: bold;"> Conexiones Pasadas.</p>
                        </div>
                </div>
            ...
            <div class="row justify-content-center">
                ...
                <div style="padding-top: 2em; " class="col-md-8 slogan">
                    <p>Por que la historia no se debe olvidar estas son nuestras conexiones del pasado.</p>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            if ($row['estado'] != 1) {
                                                ...
                                                <td><form method="post"action="../Vista/VerComprovantePago.php">
                                                    ...
                                                    <button class="mostrarImagenBtn btn btn1 btn-block" style="margin-top: 5px;">Desplegar Comprovante Pago</button>
                                                ...
                                                <td>
                                                    <form method="post" action="../Vista/MasInformacion.php">
        ...
        <form action="interfazAdministrador.php" method="post">
            ...
            /* $stmt2 = $conn->prepare("SELECT SUM(TOTAL) AS total_sumado
              ...
              $stmt2->execute();
              $result2 = $stmt2->get_result(); */
            $result2 = $consulta->ObtenerValorSumadoDeudasPorEstado(0, 0);
            $row2 = $consulta->obtenerDatosDeLasConsultas($result2);
            if ($row2['total_sumado'] == 0) {
                $row2['total_sumado'] = "";
            }
            ?>
